...
Marstek-planning.py (which plans against it), once in advise.py (which prints SoC
...
- their measured values and the reasoning behind them stay in Marstek-planning.py's
"Battery and inverter" comment block, which is the right place for a narrative that
long.
"""

CAPACITY_WH = 27900      # Wh, AlphaESS - see Marstek-planning.py for the measured
